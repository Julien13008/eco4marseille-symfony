 ...
 */
final class Version20211109115010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_195BAFB561190A32 ON parrainage (club_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_195BAFB5A76ED395 ON parrainage (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_195BAFB561190A32 ON parrainage');
        $this->addSql('DROP INDEX UNIQ_195BAFB5A76ED395 ON parrainage');
